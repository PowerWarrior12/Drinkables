...
class FavouritesAdapter(val favouriteDrinkCallback: FavouriteDrinkViewHolder.FavouriteDrinkViewListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavouriteDrinkViewHolder {
        return FavouriteDrinkViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.favourite_drink_item, parent)
        )
    }
